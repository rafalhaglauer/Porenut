...
public class ParseObjectData {
    public List<ParseObjectFace> faces;
    public int numFaces = 0;
    public List<Number3d> vertices;
    public List<Uv> texCoords;
    public List<Number3d> normals;
    ...
    public ParseObjectData(List<Number3d> vertices, List<Number3d> normals) {
    ...
    public Object3d getParsedObject() {
        ...
        parseObject(obj, new HashMap<String, Material>(), new TextureAtlas());

        return obj;
    }

    public void addVertex(Number3d vertex) {
        vertices.add(vertex);
    }

    public void addNormal(Number3d vertex) {
        normals.add(vertex);
    }

    public void addFace(ParseObjectFace face) {
        numFaces += face.faceLength - 2;
        faces.add(face);
    }
