...
public class ObjModel extends IndexedModel {
            ...
            if (lineArr.length > 3 && lineArr[0].equals("v")) {
                ...
                if (lineArr.length == 4) {
                    ...
                    if (intArr[0][2] != -1) {
                        ...
                        calculateNormal(vertices.get(index1 * 3), vertices.get(index1 * 3 + 1), vertices.get(index1 * 3 + 2),
    ...
    private void calculateNormal(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float[] normal) {
